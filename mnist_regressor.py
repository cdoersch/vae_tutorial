...
solver_fn='mnist_regressor_solver_adam.prototxt'
net_fn='mnist_regressor.prototxt'

try:
  net_proto = caffe_pb2.NetParameter()
  text_format.Merge(open(net_fn).read(), net_proto)
  caffe.draw.draw_net_to_file (net_proto, 'regressor_train_net.png', 'TB',
                               phase=caffe.TRAIN)
  caffe.draw.draw_net_to_file (net_proto, 'regressor_test_net.png', 'TB',
                               phase=caffe.TEST)
except:
...
net=caffe.Net('mnist_regressor.prototxt','snapshots/mnist_regressor_iter_60000.caffemodel',caffe.TEST)
net.forward()
...
misc.imsave('regressor.png',ut.imtile(imlist,width=15,sep=20,brightness=255))
